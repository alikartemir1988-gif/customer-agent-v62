...
- order search and lifecycle updates,
...
The current build includes persistent sessions, protected administration endpoints, configurable catalog/delivery data, order lifecycle states, a browser dashboard, health/readiness checks, audit history and safer Telegram webhook handling.

The next engineering milestone is true multi-company isolation and role-based staff access.
